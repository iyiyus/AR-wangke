  ...
  >
    ...
    >
      <ElScrollbar :style="scrollbarStyle">
        ...
        >
          <img v-if="!isDualMenu && siteConfig.logo" :src="siteConfig.logo" class="logo" style="height:32px;width:auto;max-width:120px;object-fit:contain;" />
          ...
          >
            {{ siteConfig.sitename || AppConfig.systemInfo.name }}
          </p>
        </div>
