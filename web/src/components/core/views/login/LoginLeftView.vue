...
<template>
  <div class="login-left-view">
    <div class="logo">
      <img v-if="siteConfig.logo" :src="siteConfig.logo" class="brand-img" />
      <ArtLogo v-else size="46" />
      <h1 class="title">{{ siteConfig.sitename || AppConfig.systemInfo.name }}</h1>
    </div>
